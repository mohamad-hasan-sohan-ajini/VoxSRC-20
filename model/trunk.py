...
class Trunk(nn.Module):
    """Trunk network of speaker recognition

    Args: depends on the model
    """
    def __init__(self):
...
class Bottleneck(nn.Module):
    ...
    the stride at the first 1x1 convolution(self.conv1) according to
    "Deep residual learning for image recognition:
    https://arxiv.org/abs/1512.03385. This variant is also known as
    ResNet V1.5 and improves accuracy according to
    https://ngc.nvidia.com/catalog/model-scripts/nvidia:resnet_50_v1_5_for
    pytorch.
    """
